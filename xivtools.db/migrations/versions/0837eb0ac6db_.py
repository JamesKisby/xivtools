...
Revision ID: 0837eb0ac6db
Revises: 08be8b5837cd
Create Date: 2020-01-19 18:52:57.144350
...
revision = '0837eb0ac6db'
down_revision = '08be8b5837cd'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('unk18', sa.SMALLINT(), nullable=True),
