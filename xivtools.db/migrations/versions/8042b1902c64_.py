...
Revision ID: 8042b1902c64
Revises: 8eeb427f7193
Create Date: 2020-01-21 18:49:44.987297
...
revision = '8042b1902c64'
down_revision = '8eeb427f7193'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('craftid', sa.ARRAY(sa.Integer()), nullable=True),
